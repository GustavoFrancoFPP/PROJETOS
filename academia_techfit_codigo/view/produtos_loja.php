...
try {
    ...
    $stmt = $conn->prepare("SELECT id_produtos, nome_produto, tipo_produto, categoria, preco, quantidade_estoque, url_imagem, descricao
                            FROM produtos 
                    ...
                    <div class="product-grid">
                        <?php foreach ($produtos as $produto): ?>
                            <div class="product-card" data-id="<?php echo htmlspecialchars($produto['id_produtos']); ?>">
                                <img src="<?php echo !empty($produto['url_imagem']) ? htmlspecialchars($produto['url_imagem']) : 'assets/images/imagens/remove_watermark_image_20251112_134903.png'; ?>" 
                                     alt="<?php echo htmlspecialchars($produto['nome_produto']); ?>" 
                                     class="product-image product-image-square"
